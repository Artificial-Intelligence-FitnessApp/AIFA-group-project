			...
			if( document.getElementById('gender').value === 'male'){
				...
				if(age > 18 && age < 25){
					if(finalBf > 4 && finalBf < 7){
						...
						document.getElementById('meaning').innerHTML = "You are above of the media"; 
					}else if(finalBf > 14.1 && finalBf < 17){
						document.getElementById('meaning').innerHTML = "You are in the media";
						...
						document.getElementById('meaning').innerHTML = "very bad";
					}					
				...
				if(age > 18 && age < 25){
					if(finalBf > 13 && finalBf < 17){
						...
						document.getElementById('meaning').innerHTML = "You are under of the media";
